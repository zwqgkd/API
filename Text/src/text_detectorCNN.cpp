...
cv::Ptr<cv::text::TextDetectorCNN> createI(const cv::String& modelArchFilename, const cv::String& modelWeightsFilename) {
	return cv::text::TextDetectorCNN::create(modelArchFilename, modelWeightsFilename);
}