...
template cv::Ptr<cv::text::TextDetectorCNN>;
extern "C" __declspec(dllexport) cv::Ptr<cv::text::TextDetectorCNN> createI(const cv::String& modelArchFilename, const cv::String& modelWeightsFilename);
