...
void testPosturalEstimation()
{
	...
	cv::Mat im = myread("C:/Users/14839/Desktop/headpose.PNG", 1);

	typedef bool(*solvePnP)(InputArray _opoints, InputArray _ipoints,
		InputArray _cameraMatrix, InputArray _distCoeffs,
		OutputArray _rvec, OutputArray _tvec);
	//HINSTANCE Dll = LoadLibraryA("../PosturalEstimation/target/posturalestimation.dll");
	HINSTANCE Dll = LoadLibraryA("C:/Users/14839/Desktop/opencv/posturalEstimation/bin/Release/opencv_calib3d343.dll");
	if (Dll == NULL)
	{
		printf("加载dll失败\n");
	}
	solvePnP mySolvePnP = (solvePnP)GetProcAddress(Dll, "mysolvePnP");
	...
	mySolvePnP(model_points, image_points, camera_matrix, dist_coeffs, rotation_vector, translation_vector);
	...
	// Display image.
	mywrite("C:/Users/14839/Desktop/output.png", im);
