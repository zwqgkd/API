...
EXPORT void intIO(ParamPtrArray& params) {
	int *dst = new int(get_data<int>(params[0]));
	params.push_back(make_param("dst", "int", dst));
}

EXPORT void gaussian_blur(ParamPtrArray& params) {
...
EXPORT void select_contour(ParamPtrArray& params) {
...
EXPORT void min_area_rect(ParamPtrArray& params) {
	using ContourType = std::vector<cv::Point>;
...
EXPORT void box_points(ParamPtrArray& params) {
...
EXPORT void contour_to_contours(ParamPtrArray& params) {
	using ContourType = std::vector<cv::Point>;
	using ContoursType = std::vector<ContourType>;
...
EXPORT void warp_affine(ParamPtrArray& params) {
	cv::Mat* dst = new cv::Mat;
...
EXPORT void get_rotation_matrix_2D(ParamPtrArray& params) {
...
EXPORT void total_pixels(ParamPtrArray& params) {
...
EXPORT void mean(ParamPtrArray& params) {
	cv::Mat src = get_data<cv::Mat>(params[0]);
	cv::Rect rect(
		get_data<int>(params[1]),
		get_data<int>(params[2]),
...
EXPORT void min_value(ParamPtrArray& params) {
	cv::Mat src = get_data<cv::Mat>(params[0]);
	cv::Rect rect(
		get_data<int>(params[1]),
		get_data<int>(params[2]),
...
EXPORT void max_value(ParamPtrArray& params) {
	cv::Mat src = get_data<cv::Mat>(params[0]);
	cv::Rect rect(
		get_data<int>(params[1]),
		get_data<int>(params[2]),
