...
public:
    ...
    OperatorInterface(Args&&... args) : ptr(new T(std::forward<Args>(args)...)) {}
    ~OperatorInterface();
...
struct GeliCircle {
    ...
    GeliCircle(const GeliCircle& other) : center(other.center), dI(other.dI), dO(other.dO), angleStart(other.angleStart), angleRange(other.angleRange) {
    }
